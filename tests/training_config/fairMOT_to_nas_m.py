...
from super_gradients.training.models.detection_models.pp_yolo_e import PPYoloEPostPredictionCallback_ReID, PPYoloEPostPredictionCallback
...
EXPERIMENT_NAME  = 'v1.0_yolo_nas_m_reid_full_bdd_coco'
...
model = models.get(
    MODEL_ARCH, 
    num_classes=len(CLASSES),
    checkpoint_path= '/home/ubuntu/Workspace/thinhplg-dev/object_detection/super-gradients/checkpoints/v1.0_yolo_nas_m_od_bdd/ckpt_best.pth',
